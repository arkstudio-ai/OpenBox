...
def test_wave_3_worker_and_host_metrics_are_reported():
    ...
    worker = {
        "counters": {"blob_put_raw_bytes": 10, "audit_dead_letters": 0, "failed_batches": 2},
    ...
    assert (values["failed_batches_delta"], values["blob_put_raw_bytes_delta"], values["audit_dead_letters_delta"]) == (3, 100, 0)
