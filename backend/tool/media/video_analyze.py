...
async def _resolve_source(source: str, ctx: ToolContext) -> tuple[str, str, str]:
    ...
    from tool.media.video_production import _find_owned_asset, _materialize_asset
...
async def _transcribe(audio_url: str) -> dict[str, Any]:
    from tool.media.video_production import _configured_transcription_target, _provider_transcribe
