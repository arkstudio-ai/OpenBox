...
from tool.media.video_providers import VideoRoute as VideoProviderTarget  # noqa: E402
...
def _bossip_video_payload(target: VideoProviderTarget, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    from tool.media import video_providers as _vp
...
from tool.media.video_providers import VideoRequestError as _RequestError
    ...
    while job.status not in _SEGMENT_TERMINAL:
        ...
        try:
            ...
            if state == "completed":
                ...
                from tool.media.video_providers import failure_detail
