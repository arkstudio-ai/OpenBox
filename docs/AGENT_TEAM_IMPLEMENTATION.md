...
- Local backend and Web remain available. All real-model evaluation runners
  ...
  documented in [API handoff](AGENT_TEAM_API_HANDOFF.md). API/backend/Web work
