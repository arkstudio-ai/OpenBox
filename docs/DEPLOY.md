...
- 07:38–07:46 原生 iOS 生产验收：`1.0.20+31` 完成 SSO、三轮聊天、后台恢复、冷启动登录恢复、已有 1,347 轮会话的历史分页及五栏超管只读检查。验证会话 3 对消息，trace 提交/投影 125/125，28 次历史请求全部 200，业务 trace SQL 仍为 0。此前 SSO 失败已定位为模拟器把密码首字母改成大写，保持原始大小写即登录成功。详见 [移动验收记录](MOBILE_RELEASE_1_0_20_20260916.md)。
...
- 源码 `main@73a311b` 全量构建，两边同一 tag，**gw2 与 AWS 自此回到可追溯的 main sha**，此前 gw2 的三层叠加热修镜像（714a30b / 6f90252 / 6aee878+68bb0fa）全部已在 main 内。
  ...
  [#35](https://github.com/arkstudio-ai/OpenBox/pull/35) 历史分页后端与 nginx gzip、`0b99bf1`。移动端同日发 Android `1.0.19+30` 与 iOS `1.0.19 (30)`（已上传 TestFlight，待点出口合规；见 [MOBILE_RELEASE_1_0_19_20260915.md](MOBILE_RELEASE_1_0_19_20260915.md)）。
