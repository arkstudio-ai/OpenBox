...
| A3 池 + A4 舰队 v0 | ⬜ 执行单 `docs/A3_A4_FLEET_POOL.md` | 已定（09-05）：基准镜像 openbox v2 `m-ccceuit7jn3xzwx45`；水位 5，靠收养 bossip-sh-001…013（除 007）12 台重建到 v2，先 5 台其余 reserve；规格 6c12g；dev-shanghai 不入池；本版无 webhook |
