...
| 日期 | 功能块 | 提交 | 验收证据 |
|---|---|---|---|
| 2026-09-16 | 1.0.20+31 聊天可靠性更新与 gw2 联调 | 基线 `08f5d952` | 381 项测试、拆分后 24 项历史回归、analyze、locale/800 行门禁与 iOS 构建通过；已安装并打开生产 SSO，凭据被拒绝，真实账号聊天验收待完成。移动端不新增管理端 trace 页面。见 [验收记录](MOBILE_RELEASE_1_0_20_20260916.md) |
