...
running service's limit in place, without a restart or changing `MemoryMax`.
Existing higher/unlimited operator limits are preserved. Read-only checks verify
