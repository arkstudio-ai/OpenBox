...
5. 产出：新镜像 id 写进本文 §2.2 与 `docs/operations/WUYING_SANDBOX.md`；`WUYING_SYSTEM_DISK_SIZE` 从 90 改到 50。
...
| `docs/operations/WUYING_SANDBOX.md` | per-user 章节改为「已接通」，写清两种通道、镜像 v2、`WUYING_ROUTING` |
...
| AC-11 | 文档与提交 | `docs/operations/WUYING_SANDBOX.md` 更新；本文 §8 填写；提交信息中文、按工作项分 commit；不引入本文之外的改动 |
