...
> 2026-09-18 更新：下文“厂商通道 0/8”和“当前 APK 未配置厂商通道”是 2026-09-11 当时的历史状态。现在已使用极光控制台导出的 SDK 配置接入小米客户端通道；当前构建状态与验收记录见 [Android 厂商推送配置](../../operations/ANDROID_PUSH_VENDORS.md)。
