...
| `TRAJECTORY_READ_MAX_BYTES` / `TRAJECTORY_READ_RESPONSE_BYTES` | 16777216 / 8388608 (decoded content one JSON read may load, cached content included / its response body; beyond: 413) | worker |
